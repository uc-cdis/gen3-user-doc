...
<p style="text-align: left;">The Data Dictionary Viewer is designed to make it easier to understand the data model, the field types associated with each node, and the potential values associated with each field.  Gen3 members can use it through the 'dictionary' icon at \<data.Gen3.org\> or directly at: <a href>https://data.Gen3.org/dd/</a></p>
